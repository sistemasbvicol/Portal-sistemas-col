...
(function () {
  ...
  var CSS = ""
    ...
    + "background:#0a1526;"
    + "background:linear-gradient(rgba(6,14,26,.55),rgba(6,14,26,.72)),url('login-bg.png') center/cover no-repeat,radial-gradient(1200px 600px at 70% 20%,#12385f 0%,#0a1526 55%,#050b16 100%);"
